...
export class PolarizedSelectFilter extends Filter {
  public static type: string = 'Afeefa.PolarizedSelectFilter'

  public valueToQuery (value: any): string | undefined {
    const tokens = value as string[] | null
  ...
  public queryToValue (query: string): any {
    if (!query) {
      return undefined
    }
    return query.split(',')
