    ...
    static create(filters, historyKey, filterSource) {
        ...
        if (historyKey) {
            if (filterHistory.hasFilters(historyKey)) {
                listFilters = filterHistory.getFilters(historyKey);
            }
            else {
                listFilters = new ListFilters(filters, historyKey, filterSource);
                filterHistory.addFilters(historyKey, listFilters);
            }
        }
        else {
            listFilters = new ListFilters(filters, undefined, filterSource);
        }
        return listFilters;
    }
