 ...
 */
export declare class ListFilters {
    private _filters;
    private _historyKey?;
    ...
    static create(filters: ActionFilters, historyKey?: string, filterSource?: BaseFilterSource): ListFilters;
    static fromHistory(historyKey: string): ListFilters | null;
